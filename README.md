...
| 6. Console 0.0.1              | [console.py](https://github.com/ipinmi/AirBnB_clone_v2/blob/dev/console.py)                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Add basic functionality to console program, allowing it to quit, handle empty lines and ^D          |
